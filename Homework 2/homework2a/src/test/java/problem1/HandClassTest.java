...
public class HandClassTest {
    ...
    /**
     * Test When a card is pulled from the hand, the hand now has one less card and that card is no longer in the deck.
     */
    @Test
    ...
    public void sort() {
        ...
        assertEquals("spades", "SPADES", ((HandClass) hand).getCardFromDeck(1).getSuit().getName());

        hand.sort("sortByRank");
        assertEquals("spades", 4, ((HandClass) hand).getCardFromDeck(1).getRank().getPips());
    ...
    public void shuffle() {
        ...
        hand1.shuffle();
        Card cardAfterShuffle = ((HandClass) hand1).getCardFromDeck(1);
...
/*
    ...
    public void hasSuit()
    {
        ...
        Card c2 = new CardClass(RankEnum.SEVEN, SuitEnum.HEARTS);
        Card c3 =new CardClass(RankEnum.SIX, SuitEnum.CLUBS);
        Card c4 =new CardClass(RankEnum.FIVE, SuitEnum.SPADE);
        Card c5 =new CardClass(RankEnum.FOUR, SuitEnum.SPADE);
        cards.add(c1);
        cards.add(c2);
        cards.add(c3);
        cards.add(c4);
