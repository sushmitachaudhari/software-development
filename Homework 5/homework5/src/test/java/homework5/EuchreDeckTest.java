...
public class EuchreDeckTest {
    ...
    public void shuffle() {
        ...
        List<Card> unhuffledCards = ((EuchreDeck) unshuffledDeck).getSpecialDeck();
        ...
        for (Card card : ((EuchreDeck) shuffledDeck).getSpecialDeck()) {
    ...
    public void sort() {
        ...
        //Both the decks should have different hashcode.
        ...
        Deck deck1 = EuchreDeck.getEuchreDeckInstance();
        EuchreDeck.clear();
        Deck deck2 = EuchreDeck.getEuchreDeckInstance();
