...
public class HandClassTest {
    ...
    public void constructAHand()
    {
        ...
        Hand hand = new HandClass(listofCards);

        assertEquals("hand is created", hand.showCards(), listofCards);
    ...
    public void accept() {
        ...
        assertEquals("same card", newCard, ((HandClass) hand).getCardFromDeck(1));
    }
    ...
    public void hasCard() {
        ...
        Suit suit = SuitEnum.CLUBS;
        Card newCard = new CardClassAdapter(rank, suit);
        Card card2 = new CardClassAdapter(RankEnum.NINE, suit);
