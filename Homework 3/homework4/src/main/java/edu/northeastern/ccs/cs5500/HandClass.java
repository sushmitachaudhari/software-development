...
public class HandClass implements Hand {
    ...
    {
        if(cards.isEmpty())
            throw new IllegalStateException("You are making a hand wiht no cards.");
        else
        {
    ...
    public void sort(String bySuitRankBoth){
        ...
        {
            hand.sort(CardClassAdapter.suitComparator);

        }
        else if(bySuitRankBoth.equalsIgnoreCase("Rank"))
        {
            hand.sort(CardClassAdapter.rankComparator);

        }
        else
        {
            hand.sort(CardClassAdapter.bothComparator);
        }
    ...
    public boolean equals(Object obj) {
        ...
        Hand h = (Hand) obj;
        return this.showCards() == h.showCards();
    }
